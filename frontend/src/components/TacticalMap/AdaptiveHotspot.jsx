...
import '../../styles/TacticalMap/adaptiveHotspot.css';
...
const AdaptiveHotspot = ({ 
  ...
  const compactMode = mapName === 'de_nuke';
  const compactCollapsed = compactMode && zoomLevel < 1.35 && !isSelected && !isHovered;
  ...
  return (
    <button
      className={`
        ...
        ${compactCollapsed ? 'compact-collapsed' : ''}
    ...
    >
      ...
      <div className="hotspot-core">
        <span className="hotspot-label">{compactCollapsed ? compactLabel : name}</span>
