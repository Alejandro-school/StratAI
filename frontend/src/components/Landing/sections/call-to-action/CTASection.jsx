        ...
        <div className="cta-section__inner">
          ...
          >
            <div className="cta-section__copy">
              <span className="cta-section__eyebrow">{t('cta.eyebrow')}</span>
              ...
              <div className="cta-section__buttons">
                ...
                <button className="cta-section__btn cta-section__btn--secondary" onClick={handleDemoScroll}>
                  <PlayCircle size={18} />
            ...
            <div className="cta-section__proof">
              <div className="cta-section__proof-header">
                <ShieldCheck size={18} />
                <div>
                  <span>{t('cta.proofEyebrow')}</span>
                  <strong>{t('cta.proofTitle')}</strong>
                </div>
              </div>
              <div className="cta-section__proof-list">
                <div className="cta-section__proof-item">
                  <CheckCircle2 size={16} />
                  <span>{t('cta.proofItem1')}</span>
                </div>
                <div className="cta-section__proof-item">
                  <CheckCircle2 size={16} />
                  <span>{t('cta.proofItem2')}</span>
                </div>
                <div className="cta-section__proof-item">
                  <CheckCircle2 size={16} />
                  <span>{t('cta.proofItem3')}</span>
                </div>
              </div>
            </div>
          </motion.div>
